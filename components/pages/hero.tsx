...
export default function Hero() {
  ...
  return (
    <section className="relative w-full min-h-[80vh] flex items-center px-4 sm:px-6 md:px-10 py-10 bg-gradient-to-br from-blue-600 to-blue-500 text-white rounded-xl overflow-hidden">
